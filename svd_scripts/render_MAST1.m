...
function [h]=render_MAST1(X,tnorm, fnorm, varargin)
...
eps     = 0.3; % cutoff, below this all amplitudes mapped to white
eps1    = 0.4;   % blue (eps1) to green (eps2) threshold
eps2    = 0.5;   % green (eps2) to red (1) threshold
