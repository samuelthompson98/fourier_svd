function plot_amplitude_and_mode_number_relative_differences_inner(times, relative_amplitude_differences, relative_n_differences, beta, mode_num)
    amplitude_title1 = "Relative amplitude";
    n_title1 = "Relative n";
    title2 = num2str(beta, ' difference for beta =%10.1e and mode number ');
