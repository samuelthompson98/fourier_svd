...
function [h]=render_H12(X,tnorm, fnorm)
...
eps      = 0.5; % cutoff, below this all amplitudes mapped to white
...
eps1    = 0.45;   % amplitudes mapped from white (eps) to blue (eps1)
eps2    = 0.6;   % amplitudes mapped from blue (eps1) to green (eps2)
