...
% fix 6590 =======================================
% remove bad data
xmb_590.cc_mt_2(1).data   =0;
xmb_590.cc_mt_2(4).data   =0;
xmb_590.cc_mt_2(12).data  =0;

% fix polarity
xmb_590.cc_mt_2(1).signal(:,2)  = - xmb_590.cc_mt_2(1).signal(:,2);
xmb_590.cc_mt_2(2).signal(:,2)  = + xmb_590.cc_mt_2(2).signal(:,2);
xmb_590.cc_mt_2(3).signal(:,2)  = - xmb_590.cc_mt_2(3).signal(:,2);
xmb_590.cc_mt_2(4).signal(:,2)  = - xmb_590.cc_mt_2(4).signal(:,2);
xmb_590.cc_mt_2(5).signal(:,2)  = + xmb_590.cc_mt_2(5).signal(:,2);
xmb_590.cc_mt_2(6).signal(:,2)  = - xmb_590.cc_mt_2(6).signal(:,2);
xmb_590.cc_mt_2(7).signal(:,2)  = - xmb_590.cc_mt_2(7).signal(:,2);
xmb_590.cc_mt_2(8).signal(:,2)  = - xmb_590.cc_mt_2(8).signal(:,2);
xmb_590.cc_mt_2(9).signal(:,2)  = - xmb_590.cc_mt_2(9).signal(:,2);
xmb_590.cc_mt_2(10).signal(:,2) = - xmb_590.cc_mt_2(10).signal(:,2);
xmb_590.cc_mt_2(11).signal(:,2) = - xmb_590.cc_mt_2(11).signal(:,2);
xmb_590.cc_mt_2(12).signal(:,2) = - xmb_590.cc_mt_2(12).signal(:,2);

% define toroidal postion
dphi = 2*pi/12;
for i=1:12
  xmb_590.cc_mt_2(i).phi= dphi*i;
end;
...
disp(['Input data ================================ ']);
for i=1:12
  disp(['Nt = ', num2str(size(xmb_590.cc_mt_2(i).signal,1))]);
  Nt = min([Nt size(xmb_590.cc_mt_2(i).signal,1)]);
end;
temp            = xmb_590.cc_mt_2;
xmb_590.cc_mt_2 = rmfield(xmb_590.cc_mt_2,'signal');
for i=1:12 
  xmb_590.cc_mt_2(i).signal(1:Nt,:) = temp(i).signal(1:Nt,:);
end;
disp(['Fixed data ================================ ']);
for i=1:12
  disp(['Nt = ', num2str(size(xmb_590.cc_mt_2(i).signal,1))]);
...
trace(xmb_590.cc_mt_2)

% compute FFT
set(0,'DefaultFigureVisible','off');
XMB_590.cc_mt_2=spec(xmb_590.cc_mt_2)
set(0,'DefaultFigureVisible','on');

% render centre column midplane
render(XMB_590.cc_mt_2(5));
...
% remove bad data
xmc_590.cc_mt_2(1).data   =0;
xmc_590.cc_mt_2(2).data   =0;
xmc_590.cc_mt_2(4).data   =0;
xmc_590.cc_mt_2(12).data  =0;

% fix polarity
xmc_590.cc_mt_2(3).signal(:,2)  = - xmc_590.cc_mt_2(3).signal(:,2);
xmc_590.cc_mt_2(5).signal(:,2)  = + xmc_590.cc_mt_2(5).signal(:,2);
xmc_590.cc_mt_2(6).signal(:,2)  = - xmc_590.cc_mt_2(6).signal(:,2);
xmc_590.cc_mt_2(7).signal(:,2)  = - xmc_590.cc_mt_2(7).signal(:,2);
xmc_590.cc_mt_2(8).signal(:,2)  = - xmc_590.cc_mt_2(8).signal(:,2);
xmc_590.cc_mt_2(9).signal(:,2)  = - xmc_590.cc_mt_2(9).signal(:,2);
xmc_590.cc_mt_2(10).signal(:,2) = - xmc_590.cc_mt_2(10).signal(:,2);
xmc_590.cc_mt_2(11).signal(:,2) = - xmc_590.cc_mt_2(11).signal(:,2);

% define toroidal postion
dphi = 2*pi/12;
for i=1:12
  xmc_590.cc_mt_2(i).phi= dphi*i;
end;

trace(xmc_590.cc_mt_2)

% compute FFT
set(0,'DefaultFigureVisible','off');
XMC_590.cc_mt_2=spec(xmc_590.cc_mt_2)
set(0,'DefaultFigureVisible','on');

% render centre column midplane
render(XMC_590.cc_mt_2(3));
