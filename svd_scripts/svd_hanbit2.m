...
xmd.omt(1).phi = 0;
xmd.omt(2).phi = 90/180 * pi;
xmd.omt(3).phi = 180/180 * pi;
xmd.omt(4).phi = 271/180 * pi;
...
save 16891_XMD_bit2.mat xmd XMD;

load 16891_XMD_bit2.mat xmd XMD;
...
fhigh  = 30e+3;
[Z]    = nmode_hanbit(XMD.omt,tmin,1,flow,  fhigh)
Z.shot = 9429
